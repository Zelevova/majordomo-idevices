...
class FindMyiPhone {
    ...
    /**
     * Send message on a device
     * Example: $fmi->sendMessage("dCsaBcqBOdnNop4wvy2VfIk8+HlQ/DRuqrmiwpsLdLTuiCORQDJ9eHYVQSUzmWV", "Whats up?", true, "Important Message");
     *
     * @param deviceID	ID of the device you want to play a sound
     * @param message	Message you want displayed on the device
     ...
     */
    public function sendMessage($device_id, $text, $sound = false, $subject = 'Important Message') {
        $url = "https://fmipmobile.icloud.com/fmipservice/device/" . $this->username . "/sendMessage";
